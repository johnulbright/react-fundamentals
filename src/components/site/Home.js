    ...
    return (
        <div className = "main">
            <div className="mainDiv">
                ...
                <p>This app is intended to be a starter/tutorial app for your upcoming project and a learning sandbox from your in months and uears to come should you continue to develop software with React.  In this application we will work through some of the basic React concepts, build out some small applications, and then unleash you to build your own applications.</p>
                <hr />
                <h1>Important notes</h1>
                <ul>
                    <li>Being component based, you can move on to the next module.</li>
                    <li>This styling is intentionally bland in some spots.  Just a sandbox.</li>
                    <li>At this phase, this site is not yet responsive.</li>
                    <li>Refactor the text on this page and make your own portfolio project.</li>
                    <li>This app simply scratches the surface on what is poosible with React.</li>
                    <li>We have tried to collect the very best resources for this app, and we have sited those <Link to="/resources">here</Link></li>
